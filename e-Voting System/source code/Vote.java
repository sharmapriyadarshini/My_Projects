...
public void init()
 ...
 count8 =0;
	...
	cat = new TextField("FF:"  + String.valueOf(count7));
	...
	handlecat cats = new handlecat();
 	p1.add(ch8);
	ch8.addItemListener(cats);
    p1.add(cat);
...
class  handlecat implements ItemListener
	{
	//int cont6 =count6;
...
class SingleAction implements ActionListener
{
	public void actionPerformed(ActionEvent e)
	{
		...
		cat.setText("FF :" + String.valueOf(count6)); 
